...
export const Footer = () => {
  return (
    <FooterWrapper>
      <FooterArticle>
        <h5>Acerca de:</h5>
        <p>&copy; Enbiciporcolombia es una marca registrada, cambiamos el paradigma de viajar por Colombia.</p>
        <FooterList>
          <li>
      ...
      <FooterArticle>
        <h5>Noticias:</h5>
        <p>En Colombia hay miles de paraisos por visitar en tu bici, atento a nuestras publicaciones:</p>
        <FooterList>
          <li>
      ...
      <FooterArticle>
        <h5>Suscríbete:</h5>
        <p>Haz parte del mundo enbiciporcolombia y no te pierdas de ninguna novedad:</p>
        <FooterForm>
